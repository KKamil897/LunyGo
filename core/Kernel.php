...
class Kernel {
    ...
    public function startApplication()
    {
        ...
        if($_GET['app']) $app = $this->modules('data')->getData('get')['app'];
        if($_GET['module']) $module = $this->modules('data')->getData('get')['module'];
        if($_GET['section']) $section = $this->modules('data')->getData('get')['section'];
